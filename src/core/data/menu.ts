...
export const individualMenuItems: Menu[] = [
  { main_title: 'general' },
  {
    title: 'dashboard',
    id: 'i-dashboard',
...
export const companyHomeMenuItems: Menu[] = [
  { main_title: 'general' },
  {
    title: 'home',
    id: 'c-home',
...
export const plantsMenuItems: Menu[] = [
...
export const carbonMenuItems: Menu[] = [
...
export const esgMenuItems: Menu[] = [
  { main_title: 'esg' },
  {
    title: 'dashboard',
    id: 'esg-dashboard',
...
export const sustainabilityMenuItems: Menu[] = [
...
export const geoMenuItems: Menu[] = [
...
export function getMenuForPath(pathname: string): Menu[] {
  if (pathname.startsWith('/c/plants')) return plantsMenuItems;
  if (pathname.startsWith('/c/carbon')) return carbonMenuItems;
  if (pathname.startsWith('/c/esg')) return esgMenuItems;
  if (pathname.startsWith('/c/reports')) return sustainabilityMenuItems;
  if (pathname.startsWith('/c/geo')) return geoMenuItems;
  if (pathname.startsWith('/i/')) return individualMenuItems;
  return companyHomeMenuItems;
}

export function isCompanyView(pathname: string): boolean {
  return (
    pathname.startsWith('/c/plants') ||
...
export const menuItems: Menu[] = companyHomeMenuItems;
